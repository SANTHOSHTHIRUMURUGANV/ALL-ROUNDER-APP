    ...
    <header className="sticky top-0 z-40 w-full border-b border-white/5 bg-[#0B1020]/85 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-3">
          <div className="relative flex h-10 w-10 items-center justify-center rounded-xl overflow-hidden bg-slate-950 border border-white/10 shadow-lg">
            <img src="/logo.jpg" alt="AllCounter Logo" className="h-full w-full object-cover" />
